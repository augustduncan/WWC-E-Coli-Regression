...
output$site_summary <- renderText({
  ...
  if (nrow(predict_row) > 2) {
    return("These predictions are made through logarithmic linear regression models. Each site was tested with an 
           accuracy result of between 70-85%. Swim at your own risk!")
    }
